                  ...
                  <tbody>
                    @foreach ($data as $item)
                      <tr>
                        ...
                        <td>
                          @if ($canUpdate)
                            @include('stisla.includes.forms.buttons.btn-edit', ['link' => route('laporans.edit', [$item->id])])
                          @endif
                          @if ($canDelete)
                            @include('stisla.includes.forms.buttons.btn-delete', ['link' => route('laporans.destroy', [$item->id])])
                          @endif
                        </td>
                      </tr>
                    @endforeach
